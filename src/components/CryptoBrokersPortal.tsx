...
export default function CryptoBrokersPortal({ currentUser, onRefreshUser }: CryptoBrokersPortalProps) {
  ...
  return (
    <div className="w-full space-y-6 pb-20 animate-fadeIn">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-[#0A0D14]/90 border border-slate-850 rounded-3xl backdrop-blur">
        ...
        <div className="flex items-center gap-4 text-xs font-mono">
          <div className="px-3.5 py-1.5 rounded-2xl bg-slate-950 border border-slate-850 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-4 flex flex-col space-y-4">
          ...
          <div className="bg-[#0B0E14] border border-slate-850 p-5 rounded-3xl space-y-4 flex-1 flex flex-col justify-between">
            <div>
            ...
            <div className="bg-[#0B0E14]/80 border border-slate-850/80 rounded-2xl p-4 text-xs space-y-2 mt-4">
        ...
        <div className="lg:col-span-8 flex flex-col space-y-4">
          {selectedBroker ? (
            <div className="bg-[#0B0E14] border border-slate-850 rounded-3xl p-6 shadow-xl relative flex-1 flex flex-col justify-between overflow-hidden">
              <div className="absolute top-0 right-0 h-40 w-40 bg-[#00E5FF]/3 rounded-full blur-3xl pointer-events-none"></div>

              {/* Header Title Info */}
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-slate-850 pb-5 mb-5 shrink-0">
                <div>
                ...
                <div className="flex border border-slate-850 bg-slate-950 p-1 rounded-xl text-[10px] font-bold">
                  <button
                  ...
                  {!selectedBroker.unlocked && !isAdmin ? (
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-stretch flex-1">
                      ...
                      <div className="xl:col-span-5 space-y-4 flex flex-col justify-between">
                        <div className="bg-slate-950 border border-slate-850 p-5 rounded-3xl flex-1 flex flex-col justify-between">
                          <div>
                            ...
                            {selectedBroker.activeInvestment ? (
                              <div className="space-y-4 bg-slate-900/50 p-3.5 border border-slate-850 rounded-2xl">
                              ...
                              <form onSubmit={handleInvestPoints} className="space-y-3">
                                <div className="space-y-1">
                                  ...
                                  <input
                                    ...
                                    className="w-full bg-slate-900 border border-slate-850 rounded-xl px-3 py-2 text-xs font-mono text-white focus:outline-none focus:border-cyan-500"
                              ...
                              <div className="space-y-1.5 text-[9.5px] font-mono h-24 overflow-y-auto scrollbar-none">
                                {dynamicTrades.length === 0 ? (
                                  ...
                                  dynamicTrades.map((t, idx) => (
                                    <div key={idx} className="flex justify-between items-center bg-slate-900/30 px-2 py-1 rounded border border-slate-850/25">
                                      <span className="text-slate-350">{t.ticker}</span>
                          ...
                          <div className="mt-4 pt-3 border-t border-slate-900 space-y-2 shrink-0">
                            ...
                            <a
                              ...
                              className="w-full py-2 bg-slate-900 hover:bg-slate-850 border border-slate-800 text-center text-[10px] uppercase font-bold text-gray-300 rounded-xl flex items-center justify-center gap-1.5 cursor-pointer shadow transition-all active:scale-95 text-center block"
                            >
                      ...
                      <div className="xl:col-span-7 flex flex-col justify-between">
                        <div className="bg-slate-950 border border-slate-850 p-4 rounded-3xl flex-1 flex flex-col h-[670px] relative overflow-hidden justify-between">
                          ...
                          <div className="flex justify-between items-center border-b border-slate-900 pb-2 mb-3 shrink-0 z-10 w-full">
                            <div className="flex gap-1 bg-[#05070B] p-0.5 rounded-lg border border-slate-850 text-[9px] font-bold">
                              <button
                          ...
                          <div className="flex-1 overflow-hidden relative flex flex-col justify-center items-center w-full">
                            <div className="w-full max-w-[340px] mx-auto bg-black rounded-[36px] p-2.5 border-4 border-slate-850 shadow-2xl relative h-[560px] overflow-hidden flex flex-col bg-[#05070a]">
                              ...
                              {phoneViewMode === "link" && selectedBroker.external_link ? (
                                ...
                                <div className="w-full h-full rounded-[24px] overflow-hidden bg-[#090D16] text-white flex flex-col relative select-none font-sans">
                                  ...
                                  {/* App Header */}
                                  <div className="bg-[#0D1220] p-3 pt-6 border-b border-slate-850 shrink-0 flex flex-col space-y-1 text-center items-center justify-center relative">
                                  ...
                                  <div className="flex-1 overflow-y-auto p-3 text-xs space-y-3 scrollbar-none pb-12">
                                    ...
                                    {appCurrentTab === "trade" && (
                                      <div className="space-y-3">
                                        <div className="bg-[#0B0F19] rounded-xl p-2.5 border border-slate-850 flex justify-between items-center flex-wrap shrink-0 gap-1">
                                              ...
                                              <button
                                                ...
                                                className={`w-full p-2 rounded-xl flex items-center justify-between border select-none transition-all ${
                                                  tradeCoin === coin 
                                                    ...
                                                    : "bg-[#0B0F19]/50 border-slate-850/60 hover:bg-[#0E1526]/50"
                                                }`}
                                              >
                                        ...
                                        <div className="bg-[#0B0F19] rounded-xl p-3 border border-slate-850 space-y-2.5">
                                            ...
                                            <button
                                              ...
                                              className={`py-1.5 rounded-lg text-[10px] font-black border transition-all ${
                                                tradeType === "buy" 
                                                  ...
                                                  : "bg-[#05080E] border-slate-850 hover:bg-slate-900"
                                              }`}
                                            >
                                              🟢 Spot BUY Long
                                            </button>
                                          ...
                                          <div className="space-y-1">
                                            ...
                                            <div className="flex gap-1.5 items-center">
                                              <input
                                                ...
                                                className="flex-1 bg-[#05080E] border border-slate-850 rounded-lg px-2.5 py-1.5 text-[11px] font-mono font-bold text-white focus:outline-none"
                                              />
                                          ...
                                          <div className="space-y-1">
                                            ...
                                            <div className="space-y-1 max-h-32 overflow-y-auto scrollbar-none text-[9px] font-mono">
                                              {simTradePositions.map((pos, idx) => (
                                                <div key={idx} className="bg-[#0B0F19]/80 border border-slate-850 p-2 rounded-lg flex justify-between items-center">
                                                  <div>
                                                    <span className={pos.orderType === "buy" ? "text-emerald-450 font-bold" : "text-rose-450 font-bold"}>
                                    ...
                                    {appCurrentTab === "kyc" && (
                                      <div className="space-y-3">
                                        <div className="bg-[#0B0F19] p-3 border border-slate-850 rounded-xl space-y-2 text-center">
                                        ...
                                        {kycSubmitStatus === "unsubmitted" ? (
                                          <form onSubmit={(e) => {
                                          ...
                                          }} className="space-y-3 bg-[#0B0F19] p-3 border border-slate-850 rounded-xl text-left">
                                            ...
                                            <div className="space-y-1">
                                              ...
                                              <input
                                                ...
                                                className="w-full bg-[#05080E] border border-slate-850 rounded-lg px-2 text-white text-[10.5px] py-1.5 focus:outline-none"
                                              />
                                            </div>
                                          ...
                                          <div className="p-8 text-center space-y-2 bg-[#0B0F19] rounded-xl border border-slate-850">
                                          ...
                                          <div className="p-6 text-center space-y-3 bg-emerald-950/20 border border-emerald-500/20 rounded-xl">
                                            ...
                                            <div className="p-2.5 rounded-xl bg-slate-950/80 text-[10px] text-gray-300 font-mono border border-slate-850 text-left space-y-1">
                                    ...
                                    {appCurrentTab === "spin" && (
                                      <div className="space-y-4 text-center flex flex-col items-center">
                                        <div className="bg-[#0B0F19] p-2.5 border border-slate-850 rounded-xl tracking-wide w-full flex justify-between items-center text-left">
                                          <div>
                                    ...
                                    {appCurrentTab === "refs" && (
                                      <div className="space-y-3">
                                        <div className="bg-[#0B0F19] p-3 border border-slate-850 rounded-xl space-y-1 shadow-inner">
                                        ...
                                        <div className="space-y-2 text-left">
                                          <div className="p-2.5 rounded-xl bg-slate-950/80 border border-slate-850 space-y-1 text-[10px] font-mono">
                                            <span className="text-[8px] text-gray-500 font-bold block uppercase font-mono">Affiliate promo code</span>
                                            <div className="flex justify-between items-center bg-[#07090D] p-1.5 rounded border border-slate-850">
                                        ...
                                        <div className="space-y-1">
                                          ...
                                          <div className="space-y-1 max-h-24 overflow-y-auto scrollbar-none text-[8.5px] font-mono select-none">
                                            {referrals.map((ref, idx) => (
                                              <div key={idx} className="bg-[#0B0F19] border border-slate-850 p-1.5 rounded flex justify-between text-left items-center">
                                                <div>
                                  ...
                                  <div className="absolute bottom-0 right-0 left-0 bg-[#0D1220] border-t border-slate-850 p-1 flex justify-around items-center shrink-0 text-[8.5px] font-black tracking-wide uppercase font-mono z-20">
                                    <button 
              ...
              {activeSubTab === "admin" && isAdmin && (
                <div className="space-y-5">
                  ...
                  <div className="flex bg-[#05070A] p-1 border border-slate-850 rounded-xl max-w-xs text-[10.5px] font-bold mb-2">
                    <button 
                      onClick={() => {
                        setAdminCreateMode(false);
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-850 rounded-xl px-3.5 py-2 text-xs text-white"
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-850 rounded-xl px-3.5 py-2 text-xs font-mono text-white"
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-850 rounded-xl px-3.5 py-2 text-xs font-mono text-white text-emerald-400"
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-850 rounded-xl px-3.5 py-2 text-xs font-mono text-white text-yellow-500"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1 text-left">
                          ...
                          <div className="flex gap-2">
                            <label className="flex-1 bg-slate-950 border border-dashed border-slate-850 hover:bg-slate-900/40 p-2.5 rounded-xl cursor-pointer text-center text-xs font-mono text-slate-300">
                      ...
                      {adminUploadedHtml && (
                        <div className="space-y-1 font-mono text-[9px]">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-[#05070B] border border-slate-850 rounded-xl p-2.5 text-gray-500 whitespace-pre scrollbar-none"
                          />
                        </div>
                      )}
              ...
              {activeSubTab === "users" && isAdmin && (
                <div className="space-y-4 text-left">
                  <div className="flex justify-between items-center bg-[#07090D] p-3 border border-slate-850 rounded-2xl">
                    <div>
                  ...
                  {selectedUserForEdit ? (
                    <form onSubmit={handleUpdateUsersRoleOrPoints} className="bg-slate-950 p-4 border border-slate-850 rounded-2xl space-y-4">
                    ...
                    <div className="overflow-x-auto rounded-3xl border border-slate-850 bg-slate-950/80">
                      <table className="w-full text-left border-collapse text-xs select-none">
                        <thead>
                          <tr className="bg-slate-950 border-b border-slate-850 font-mono text-gray-500 text-[9.5px]">
            ...
            <div className="bg-[#0B0E14] border border-slate-850 rounded-3xl p-12 text-center text-xs text-slate-500 italic font-mono flex items-center justify-center h-full">
